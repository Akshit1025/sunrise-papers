  ...
  return (
    <div className="my-4">
      ...
      <p className="paragraph">
        Have a question or want to discuss a project? Feel free to reach out to
        us using the form below.
      </p>
      <form
        className="form p-4 border rounded shadow-sm"
      ...
      >
        ...
        <button
          type="submit"
          className="btn btn-lg submit-button rounded-pill mt-3"
        >
          Send Message
        </button>
      </form>
