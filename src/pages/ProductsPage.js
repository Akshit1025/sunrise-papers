  ...
  return (
    <div className="my-4">
      ...
      <p className="paragraph">
        Discover our innovative products designed to enhance your experience. We
        focus on quality and user satisfaction.
      </p>
      {products.length === 0 ? (
            ...
            <div key={product.id} className="col">
              <div className="card h-100 shadow-sm border-0 service-card">
                <div className="card-body">
                  {/* Using custom CSS variables for color */}
                  <h5
                    className="card-title mb-3 service-title"
                    style={{ color: "var(--sp-dark-gray)" }}
                  >
                    {product.name}
                  </h5>
                  <p
                    className="card-text service-description"
